"""
RuundPDF v2.9.2 - PDF Reader с РАБОЧИМ управлением озвучкой и ВОССТАНОВЛЕННЫМ копированием текста
С исправленным отслеживанием текущей страницы и гибкими настройками диапазона чтения
...
class TTSController(QObject):
    ...
    def start_reading(self):
        ...
        self.is_paused = False
        self.should_stop = False
        self.current_page = self.read_from_page  # Начинаем с заданной страницы
...
# ============================================================================
# КЛАСС ПЛЕЕРА ОЗВУЧКИ (С ОТСЛЕЖИВАНИЕМ ТЕКУЩЕЙ СТРАНИЦЫ)
# ============================================================================
class TTSPlayerWidget(QWidget):
    """Плеер озвучки с отслеживанием текущей страницы"""
    ...
    def start_reading(self):
        ...
        # Устанавливаем текущую страницу для отслеживания
        self.controller.current_page = self.read_from_page
    ...
    def resume_reading(self):
        """Продолжает чтение с паузы"""
        # При продолжении читаем с той же страницы, где остановились
    ...
    def stop_reading(self):
        ...
        self.progress_bar.setValue(self.read_from_page + 1)
