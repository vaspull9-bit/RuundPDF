"""
RuundPDF v2.9.0 - PDF Reader с РАБОЧИМ управлением озвучкой
        ...
        try:
            ...
            for page_num in range(self.current_page, self.end_page + 1):
                ...
                try:
                    ...
                    # Разбиваем текст на предложения для лучшего управления
                    sentences = self._split_into_sentences(text)
                    
                    # Читаем каждое предложение с возможностью паузы/остановки
                    for sentence in sentences:
                        ...
                        if sentence.strip():
                            ...
                            self.current_tts_engine.say(sentence)
...
class PDFViewerApp(QMainWindow):
    ...
    def show_about_dialog(self):
        ...
        info_text.setHtml("""
            <p align='center'><strong>RuundPDF v2.9.0</strong></p>
